...
angle <- getElevation(calib2, known.coord = c(lon.calib, lat.calib), lnorm.pars = TRUE)[1]
...
cL <- changeLight(twl, quantile=0.95, summary = F, days = 2)

## ---- fig.height=8, fig.width = 6----------------------------------------
siteMap(crds1, site = cL$site, xlim = c(-12, 25), ylim = c(0, 50))
